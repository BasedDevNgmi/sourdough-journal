...
import { AnimatedDoughBackground } from './components/AnimatedDoughBackground';
...
const AppContent = () => {
    ...
    const { session, initialize, isInitialized } = useAuthStore();
    const [isScrolled, setIsScrolled] = useState(false);

    useEffect(() => {
        initialize();
        loadLoaves();
    }, [initialize, loadLoaves]);
    ...
    if (!isInitialized) return null; // Avoid flicker while hydrating session
